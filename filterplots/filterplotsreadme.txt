...
specareaphotonstack contains a function for binning, a function for loading text from files, and a nested for loop which will plot the spectra of a file, the effective area of a filter, and the photon count through that filter, for each filter.
